    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_id', models.CharField(blank=True, null=True, verbose_name='id_chat в Telegram')),
                ('role', models.CharField(blank=True, choices=[('owner', 'Пользователь'), ('admin', 'Администратор')], default='owner', max_length=20, null=True)),
